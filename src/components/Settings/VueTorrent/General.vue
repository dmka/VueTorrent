...
import { defaultDateFormat, defaultDurationFormat, FilterType, PaginationPosition, TitleOptions, defaultWebuiSettings } from '@/constants/vuetorrent'
...
const resetSettings = () => {
  ...
  window.localStorage.setItem('vuetorrent_webuiSettings', JSON.stringify(defaultWebuiSettings))
  location.reload()
}
